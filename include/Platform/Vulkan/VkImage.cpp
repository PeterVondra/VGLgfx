...
namespace vgl
{
	namespace vk
	{
		...
		void Image::destroy()
		{
			...
			Utils::Logger::logMSG("Destroyed vulkan Image", "VulkanImage", Utils::Severity::Trace);
		}
		...
		void ImageCube::destroy()
		{
			...
			Utils::Logger::logMSG("Destroyed vulkan ImageCube", "VulkanImageCube", Utils::Severity::Trace);
		}
