...
namespace Utils
{
	...
	class Logger
	{
		public:
			...
			//write to log file
			static void logMSG(const std::string p_Content);
			static void logMSG(const char* p_Content);
			static void logMSG(const std::string p_Content, const char* p_Title, SeverityDetails p_Severity);
			static void logMSG(const char* p_Content, const char* p_Title, SeverityDetails p_Severity);
			static void logMSG(const std::string p_Content, const char* p_Title, ResultDetails p_Result);
