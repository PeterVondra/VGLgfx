...
namespace vgl
{
	...
	inline static void DrawVec3Control(const std::string p_Label, Vector3f& p_Vec3f, float p_ResetValue = 0.0f, float p_Speed = 0.1f, float p_ColumnWith = 100.0f)
	{
		...
		ImGui::SameLine();
		ImGui::DragFloat("##X", &p_Vec3f.x, p_Speed, 0.0f, 0.0f, "%.5f");
		ImGui::PopItemWidth();
		ImGui::SameLine();
		...
		ImGui::PopStyleColor(3);
		ImGui::SameLine();
		ImGui::DragFloat("##Y", &p_Vec3f.y, p_Speed, 0.0f, 0.0f, "%.5f");
		ImGui::PopItemWidth();
		ImGui::SameLine();
		...
		ImGui::PopStyleColor(3);
		ImGui::SameLine();
		ImGui::DragFloat("##Z", &p_Vec3f.z, p_Speed, 0.0f, 0.0f, "%.5f");
		ImGui::PopItemWidth();
		ImGui::SameLine();
