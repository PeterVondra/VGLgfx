...
namespace vgl
{
	namespace vk
	{
		...
		bool g_Pipeline::create(g_PipelineInfo p_PipelineInfo)
		{
			...
			if (p_PipelineInfo.p_Shader->m_GeometryShaderStageInfo.sType == VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO)
				shaderStages.push_back(p_PipelineInfo.p_Shader->m_GeometryShaderStageInfo);
